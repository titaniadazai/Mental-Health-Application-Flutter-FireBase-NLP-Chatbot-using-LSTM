...
class DepressionExercise extends StatefulWidget {
  const DepressionExercise({super.key});

  @override
  State<DepressionExercise> createState() => _DepressionExerciseState();
}

class _DepressionExerciseState extends State<DepressionExercise> {
  @override
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Padding(
            ...
            children: <Widget>[
              Text("Exercise Plan for Depression",
