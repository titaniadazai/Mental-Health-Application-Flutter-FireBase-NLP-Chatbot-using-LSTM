...
class HypertensionExercise extends StatefulWidget {
  const HypertensionExercise({super.key});

  @override
  State<HypertensionExercise> createState() => _HypertensionExerciseState();
}

class _HypertensionExerciseState extends State<HypertensionExercise> {
  @override
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Padding(
            ...
            children: <Widget>[
              Text("Exercise Plan for Hypertension",
